...
// Kept for the palette but currently unused (uncomment when needed):
// pub const WHITE: Colour = Colour::from_rgb(255, 255, 255);
// pub const LIGHT_GRAY: Colour = Colour::from_rgb(153, 170, 181); // == GRAY
// pub const FUCHSIA: Colour = Colour::from_rgb(235, 69, 158); // == PINK
